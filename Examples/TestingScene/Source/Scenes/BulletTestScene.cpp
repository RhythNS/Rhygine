...
void BulletTestScene::InnerInit()
{
	...
	RhyBullet::RigidBody* boxBody = box->AddComponent<RhyBullet::RigidBody>();
	...
	RhyBullet::RigidBody* staticBoxBody = staticBox->AddComponent<RhyBullet::RigidBody>();
	...
	RhyBullet::RigidBody* groundBody = ground->AddComponent<RhyBullet::RigidBody>();
	...
	std::vector<RhyBullet::RigidBody*> bodies = { boxBody, staticBoxBody };
