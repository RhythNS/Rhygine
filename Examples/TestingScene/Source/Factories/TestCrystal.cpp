...
void TestCrystal::AddData(GameObject* toAddTo)
{
	...
	TexLitNormalMapShader* tlnms = static_cast<TexLitNormalMapShader*>(drawer->AddBindable(std::make_unique<TexLitNormalMapShader>("Assets\\PresentScene\\crystal\\Crystal_004_basecolor.jpg", "Assets\\PresentScene\\crystal\\Crystal_004_normal.jpg")));
