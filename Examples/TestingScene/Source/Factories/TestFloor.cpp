...
void TestFloor::AddData(GameObject* toAddTo)
{
	...
	TexLitNormalMapShader* tlnms = static_cast<TexLitNormalMapShader*>(drawer->AddBindable(std::make_unique<TexLitNormalMapShader>("Assets\\PresentScene\\wood\\Wood_planks_011_basecolor.jpg", "Assets\\PresentScene\\wood\\Wood_planks_011_normal.jpg", desc)));
