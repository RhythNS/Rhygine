...
void TestModel::AddData(GameObject* toAddTo)
{
	...
	transform->localPosition.Set(-10.0f, 0.0f, 10.0f);
	...
	const std::string pFile = "Assets\\TestModels\\spot.obj";
	...
	drawer->AddBindable(std::make_unique<Texture>("Assets\\TestModels\\spot_texture.png", 0));
